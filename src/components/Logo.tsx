...
export function Logo() {
  ...
  return (
    <motion.div variants={container} initial="hidden" animate="visible" className="md:absolute 2xl:fixed fixed top-12 md:top-8 left-36 2xl:left-20 lg:left-10 sm:left-6">
      <a href="/">
